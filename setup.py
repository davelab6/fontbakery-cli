...
msg = 'Python module `fontforge` is required. ' +
      'Install it with `apt-get install python-fontforge` or '+ 
...
# require ttfautohint
msg = 'Command line tool `ttfautohint` is required. ' +
    'Install it with `apt-get install ttfautohint` or ' +
